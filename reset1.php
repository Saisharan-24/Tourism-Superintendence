...
$qry=mysql_query("update register set psw='$psw' where email='$email'");
	   ...
	   <table width="46%" border="0" align="center">
		...
		<td width="48%">&nbsp;</td>
         ...
         <tr>
           ...
           <td><label>
           <input name="psw" type="password" id="psw"  required/>
           </label></td>
         </tr>
         <tr>
           <td height="44" align="center"><span class="style2"><strong>Enter New Password Again</strong></span></td>
           <td><label>
             <input name="psw1" type="password" id="psw1"  required/>
           </label></td>
         </tr>
         <tr>
           <td>&nbsp;</td>
